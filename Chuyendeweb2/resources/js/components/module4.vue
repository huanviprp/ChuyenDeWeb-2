<template>
    ...
    <div class="row comic-new" v-if="Comics && Comics.length">
        <div class="col-md-3 comic" v-for="Comic of Comics" :key="Comic.Comic_id">
            <a v-bind:href="'/detail/?id=' + Comic.Comic_id"><img class="img-comic" v-bind:src="Comic.Img_feature"></a>
            ...
            <div class="new-chapter">
                <a class="name-comic" v-bind:href="'/detail/?id=' + Comic.Comic_id"><b>{{ Comic.Name }}</b></a>
                <ul>
